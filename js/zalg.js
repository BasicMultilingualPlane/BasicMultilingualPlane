...
var zalgo_down = ["\u0316", "\u0317", "\u0318", "\u0319", "\u031c", "\u031d", "\u031e", "\u031f", "\u0320", "\u0324", "\u0325", "\u0326", "\u0329", "\u032a", "\u032b", "\u032c", "\u032d", "\u032e", "\u032f", "\u0330", "\u0331", "\u0332", "\u0333", "\u0339", "\u033a", "\u033b", "\u033c", "\u0345", "\u0347", "\u0348", "\u0349", "\u034d", "\u034e", "\u0353", "\u0354", "\u0355", "\u0356", "\u0359", "\u035a", "\u0323"];
var zalgo_mid = ["\u0315", "\u031b", "\u0340", "\u0341", "\u0358", "\u0321", "\u0322", "\u0327", "\u0328", "\u0334", "\u0335", "\u0336", "\u034f", "\u035c", "\u035d", "\u035e", "\u035f", "\u0360", "\u0362", "\u0338", "\u0337", "\u0361", "\u0489"];
...
function zalgo_textarea(id) {
    ...
    for (var i = 0; i < txt.length; i++) {
        ...
        if (document.getElementById("zalgo_opt_mini").checked) {
            ...
            if (document.getElementById("zalgo_opt_normal").checked) {
                num_up = rand(16) / 2 + 1;
                num_mid = rand(6) / 2;
                num_down = rand(16) / 2 + 1
            } else {
                num_up = rand(640) / 4 + 3;
                num_mid = rand(320) / 4 + 1;
                num_down = rand(640) / 4 + 3
            }
        }
